<div class="container">
	...
	<div class="col lg-6 col-md-6 col-sm-6 col-xs-12">
		...
		<?php for( $i = 0; $i < sizeOf($rooms); $i++) { ?>
			<li class="list-group-item"><b><a href="<?php echo site_url('Management/displayRoom/'.$location_details[0]->ID.'/'.$rooms[$i]->menuItem_id); ?>"><?php echo $rooms[$i]->menuItem_name;?></a></b>
			<input type="hidden" name="menuItem_id" value=""></input>
			<input type="hidden" name="menuItem_name" value=""></input>
			</li>
		<?php } ?>
		</ul>
	</div>
